...
public:
    ...
    void pop_back();
    void pop_front();
    void insert(T newvalue, size_t index);
...
template<typename T>
void MyList<T>::insert(T newvalue, size_t index) 
{
    if (size >= index + 1)
    {
        Node* current = head;
...
template<typename T>
T MyList<T>::get_elem(size_t index) 
{
    if (size >= index + 1) 
    {
        Node* current = head;
...
template<typename T>
void MyList<T>::remove(size_t index) 
{
    if (size >= index + 1) 
    {
...
template<typename T>
void MyList<T>::set(size_t index, T newvalue) 
{
    if (size >= index + 1) 
    {
        Node* current = head;
